                        ...
                        if(!$result){
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><a href="view_page_members.php?id=<?php echo $row['member_id']?>" class="btn btn-secondary"><i class="bi bi-eye" style="padding: 4px;"></i></a></td>
                                    <!-- <td><a href="update_page_1.php?id=<?php echo $row['member_id']?>" class="mybtn1 btn btn-light btn-small"><i class="bi bi-pencil" style="padding: 4px;"></i></a></td> -->
                                    <td><a href="delete_page.php?id=<?php echo $row['member_id']?>" class="mybtn2 btn btn-light btn-small"><i class="bi bi-trash" style="padding: 4px;"></i></a></td>
                                </tr>
                            <?php
                            }
                        }
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <!-- <input type="submit" class="btn btn-success" name="add_members"> -->
                </div>
            </div>
        </div>
    </div>
